...
file_path = '../data/raw/moex/exported_moex_list.csv'
...
instrument_types_of_interest = ["Акция привилегированная", "Акция обыкновенная", "Депозитарные расписки иностранного эмитента на акции"]
...
filtered_file_path = '../data/processed/filtered_decoded_moex_list.csv'
